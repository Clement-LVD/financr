...
If you don't know the ticker symbol of an asset, exploring the results of `financr::search_summary()` or `search_from_text()` is a way to find it.
...
See the vignette on [`search_summarys()` and `get_historic()`](https://clement-lvd.github.io/financr/articles/get_info_and_historic.html).
