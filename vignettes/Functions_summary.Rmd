...
Other R packages retrieves data from the same source as `'financr'`, i.e. Yahoo Finance. E.g., [`'yahoofinancer'`](https://cran.r-project.org/package=yahoofinancer), [`yfr`](https://cran.r-project.org/package=yfR), [`'quantmod'`](https://cran.r-project.org/package=quantmod) and the packages that depends on them such as [`stocks`](https://cran.r-project.org/package=stocks) that depends on `'quantmod'`. 
...
deps <- data.frame(Package = c("`'financr'`", "`'yahoofinancer'`", '`yfr`', "`'quantmod'`")
