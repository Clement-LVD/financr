...
"`search_assets('Saab', add_latest_values = T)`"
...
fn <- data.frame(Example =   c( "`get_values('SDV1.F')`"
  
  , "`get_historic('SDV1.F')` <br> & `get_historic_light('SDV1.F')`"
...
,"Asset symbol(s)"
 ...
 , Data.frame_returned =  c("**Latest** insights and financial values"
...
<!-- In order to return `integer` or `numeric` class of values, some of the texts provided by the Yahoo Finance API are converted into numeric values, e.g., `"1.2M"` is turned into `1200000` and `"85%"` into `85`.  -->
