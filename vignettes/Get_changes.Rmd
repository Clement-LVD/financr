---
title: "Deal with currencies"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Deal with currencies}
...
- `last_currencies()` return a list of currencies symbols and names.
...
```{r currencies2}
few_currencies <- last_currencies(keep = c("RON",  "USD"), add_usd_values = T )
few_currencies
```
